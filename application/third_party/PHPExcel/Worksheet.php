...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    private static function _checkSheetTitle($pValue)
    {
        ...
        // Maximum 40 characters allowed for sheet title
        if (PHPExcel_Shared_String::CountCharacters($pValue) > 40) {
            throw new PHPExcel_Exception('Maximum 40 characters allowed in sheet title.');
        }
