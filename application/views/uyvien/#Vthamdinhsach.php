					...
					<div class="ibox-content">
						<table class="table table-bordered">
							<thead>
								...
								<th class="text-center" width="14%">Nhà xuất bản và năm xuất bản</th>
									...
									{if isset($listBook[$value['PK_iMaGiaiDoan']])}
										...
										{foreach $listBook[$value['PK_iMaGiaiDoan']] as $k => $v}
											<tr>
												...
												<td class="text-center">
												<button type="button" class="btn btn-xs btn-success" title="Sửa thông tin sách phục vụ đào tạo" name="btnFix" value="{$v.PK_iMaSach}" data-toggle="modal" data-target="#modalReview">Thẩm định</button>
												</td>
											</tr>
										{/foreach}
									{/if}
						...
						<button type="submit" value="" name="btnSaveScoreBook" class="btn btn-primary" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Đang cập nhật điểm" title="Cập nhật điểm">
											Lưu
										</button>
						<div class="row">
					...
					<div class="ibox-content">
						<table class="table table-bordered">
							...
							<tbody>	
									...
									<tr> 
										<td class="text-center" colspan="2" width="17%"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
